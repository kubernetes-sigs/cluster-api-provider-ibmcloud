...
- IBMPOWERVS_WORKSPACE_ID : ID of the PowerVS workspace. Refer [here](https://cloud.ibm.com/docs/power-iaas?topic=power-iaas-power-iaas-cli-reference-v1#ibmcloud-pi-workspace)
