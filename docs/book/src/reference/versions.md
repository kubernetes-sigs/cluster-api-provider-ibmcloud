...
|:---------------|:------------|:--------|:-------|
| **v0.15.x** | v1beta3 | v1beta2 | ✅ N — Standard support |
...
|:---------------|:------------|:--------|:----------|
| v0.12.x | v1beta2 | v1beta2 | 2025-12-15 (v0.15.0 release) |
...
|:---------------|:------------------------|
| v0.[13-15].x, main | CAPI v1beta2 (v1.11.x – v1.12.x+) |
| v0.[4-12].x | CAPI v1beta1 (v1.1.x – v1.10.x) |
| v0.2.x – v0.3.x | CAPI v1beta1 (v1.1.x – v1.10.x) |
| v0.1.x | CAPI v1alpha4 (v0.4) |

> **Current stable:** CAPIBM v0.15.x targets **CAPI v1beta2**, which corresponds to
> CAPI releases `v1.11.x` and `v1.12.x`.
...
|:---------------|:-------------|:---------------------------------------------|
| v0.[13-15].x, main | v1.11.x – v1.12.x | Kubernetes v1.29 – v1.33 |
| v0.[4-12].x | v1.1.x – v1.10.x | Kubernetes v1.20 – v1.32 |
...
versions** in a single upgrade. For example, upgrading from v0.11.x directly to v0.14.x is the
