...
func TestIBMPowerVSClusterReconciler_Reconcile(t *testing.T) {
	...
	t.Run("Successfully reconcile", func(t *testing.T) {
		...
		reconciler := &IBMPowerVSClusterReconciler{
			Client: testEnv.Client,
			ClientFactory: powervs2.ClientFactory{
...
func TestIBMPowerVSClusterReconciler_reconcile(t *testing.T) {
	testCases := []struct {
		name                string
		powervsClusterScope func() *powervs2.ClusterScope
		clusterStatus       bool
		...
		},
		{
			...
			powervsClusterScope: func() *powervs2.ClusterScope {
				clusterScope := &powervs2.ClusterScope{
					IBMPowerVSCluster: &infrav1.IBMPowerVSCluster{
						ObjectMeta: metav1.ObjectMeta{
							Finalizers:  []string{infrav1.IBMPowerVSClusterFinalizer},
...
func TestReconcileVPCResources(t *testing.T) {
	testCases := []struct {
		name                    string
		powerVSClusterScopeFunc func() *powervs2.ClusterScope
