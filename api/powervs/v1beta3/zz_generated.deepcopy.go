...
import (
	...
	"sigs.k8s.io/cluster-api-provider-ibmcloud/api/vpc/v1beta2"
...
func (in *IBMPowerVSClusterSpec) DeepCopyInto(out *IBMPowerVSClusterSpec) {
	*out = *in
	...
	if in.VPCRoutingTables != nil {
		in, out := &in.VPCRoutingTables, &out.VPCRoutingTables
		*out = make([]v1beta2.VPCRoutingTable, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *IBMPowerVSClusterStatus) DeepCopyInto(out *IBMPowerVSClusterStatus) {
	*out = *in
	...
	if in.VPCRoutingTables != nil {
		in, out := &in.VPCRoutingTables, &out.VPCRoutingTables
		*out = make([]VPCRoutingTableStatus, len(*in))
		copy(*out, *in)
	}
	if in.VPCSecurityGroups != nil {
		in, out := &in.VPCSecurityGroups, &out.VPCSecurityGroups
