...
func (in *IBMPowerVSClusterStatus) DeepCopyInto(out *IBMPowerVSClusterStatus) {
	*out = *in
	...
	if in.VPCSubnetID != nil {
		in, out := &in.VPCSubnetID, &out.VPCSubnetID
		*out = new(string)
		**out = **in
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *IBMTransitGatewayResource) DeepCopyInto(out *IBMTransitGatewayResource) {
	*out = *in
	if in.Name != nil {
		in, out := &in.Name, &out.Name
		*out = new(string)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new IBMTransitGatewayResource.
func (in *IBMTransitGatewayResource) DeepCopy() *IBMTransitGatewayResource {
	if in == nil {
		return nil
	}
	out := new(IBMTransitGatewayResource)
	in.DeepCopyInto(out)
	return out
}
