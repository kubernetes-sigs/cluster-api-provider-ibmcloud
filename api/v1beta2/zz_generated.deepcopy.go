...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CosBucket) DeepCopyInto(out *CosBucket) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CosBucket.
func (in *CosBucket) DeepCopy() *CosBucket {
	if in == nil {
		return nil
	}
	out := new(CosBucket)
...
func (in *IBMPowerVSClusterStatus) DeepCopyInto(out *IBMPowerVSClusterStatus) {
	*out = *in
	...
	if in.COSBucketID != nil {
		in, out := &in.COSBucketID, &out.COSBucketID
		*out = new(string)
		**out = **in
	}
	if in.ControlPlaneLoadBalancer != nil {
