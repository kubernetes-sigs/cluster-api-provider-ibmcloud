...
const (
	...
	// COSBucketReadyCondition reports on the successful reconciliation of a COS bucket.
	COSBucketReadyCondition capiv1beta1.ConditionType = "COSBucketCreated"
	// COSBucketReconciliationFailedReason used when an error occurs during COS bucket reconciliation.
	COSBucketReconciliationFailedReason = "COSBucketCreationFailed"
)
