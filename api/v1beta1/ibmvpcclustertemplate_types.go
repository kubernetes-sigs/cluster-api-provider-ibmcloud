...
type IBMVPCClusterTemplateSpec struct {
	Template IBMVPCClusterTemplateResource `json:"template"`
}

// +kubebuilder:object:root=true
// +kubebuilder:resource:path=ibmvpcclustertemplates,scope=Namespaced,categories=cluster-api,shortName=ibmpowervsct
...
// IBMVPCClusterTemplate is the schema for IBM Power VS Kubernetes Cluster Templates.
