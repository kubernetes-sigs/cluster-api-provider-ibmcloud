...
require (
	...
	sigs.k8s.io/cluster-api/hack/tools v0.0.0-20231003103052-93daac9ae427
...
require (
	...
	github.com/aquasecurity/trivy-kubernetes v0.5.8-0.20230928134646-b414e546fe6d // indirect
