...
require (
	...
	sigs.k8s.io/cluster-api/hack/tools v0.0.0-20220719154607-2fc8bcd52108
...
require (
	...
	sigs.k8s.io/kubebuilder/docs/book/utils v0.0.0-20220713123538-e116b5423ff0 // indirect
