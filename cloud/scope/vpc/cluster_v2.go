...
// ClusterScopeV2 defines a scope defined around a VPC Cluster for the V2 workflow.
type ClusterScopeV2 struct {
	logr.Logger
	Client      client.Client
...
func NewClusterScopeV2(params ClusterScopeParamsV2) (*ClusterScopeV2, error) {
...
func (s *ClusterScopeV2) PatchObject() error {
	return s.patchHelper.Patch(context.TODO(), s.IBMVPCCluster)
}

// Close closes the current scope persisting the cluster configuration and status.
func (s *ClusterScopeV2) Close() error {
	return s.PatchObject()
}

// Name returns the CAPI cluster name.
func (s *ClusterScopeV2) Name() string {
	return s.Cluster.Name
}

// NetworkSpec returns the ClusterScopeV2's Network spec.
func (s *ClusterScopeV2) NetworkSpec() *infrav1.VPCNetworkSpec {
	return s.IBMVPCCluster.Spec.Network
}

// NetworkStatus returns the ClusterScopeV2's Network status.
func (s *ClusterScopeV2) NetworkStatus() *infrav1.VPCNetworkStatus {
	return s.IBMVPCCluster.Status.Network
}

// CheckTagExists checks whether a user tag already exists.
func (s *ClusterScopeV2) CheckTagExists(tagName string) (bool, error) {
...
func (s *ClusterScopeV2) GetAPIServerPort() int32 {
...
func (s *ClusterScopeV2) GetControlPlaneSubnetIDs() ([]string, error) {
...
func (s *ClusterScopeV2) GetLoadBalancerHostName() (*string, error) {
...
func (s *ClusterScopeV2) GetNetworkResourceGroupID() (string, error) {
...
func (s *ClusterScopeV2) GetResourceGroupID() (string, error) {
...
func (s *ClusterScopeV2) GetSecurityGroupID(name string) (*string, error) {
	// Check Status first.
...
func (s *ClusterScopeV2) getSecurityGroupIDFromStatus(name string) *string {
...
func (s *ClusterScopeV2) GetServiceName(resourceType infrav1.ResourceType) *string {
	switch resourceType {
...
func (s *ClusterScopeV2) GetSubnetID(name string) (*string, error) {
	// Check Status first
...
func (s *ClusterScopeV2) GetVPCID() (*string, error) {
...
func (s *ClusterScopeV2) setLoadBalancerStatus(loadBalancer *infrav1.VPCLoadBalancerStatus) {
...
func (s *ClusterScopeV2) SetResourceStatus(resourceType infrav1.ResourceType, resource *infrav1.ResourceStatus) { //nolint:gocyclo
...
func (s *ClusterScopeV2) TagResource(tagName string, resourceCRN string) error {
...
func (s *ClusterScopeV2) ReconcileVPC(ctx context.Context) (bool, error) {
...
func (s *ClusterScopeV2) createVPC() error {
...
func (s *ClusterScopeV2) ReconcileVPCCustomImage(ctx context.Context) (bool, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (s *ClusterScopeV2) createCustomImage(ctx context.Context) error {
...
func (s *ClusterScopeV2) buildCOSObjectHRef(ctx context.Context) (*string, error) {
	log := ctrl.LoggerFrom(ctx)
	// TODO(cjschaef): Remove in favor of webhook validation.
...
func (s *ClusterScopeV2) ReconcileSubnets(ctx context.Context) (bool, error) {
...
func (s *ClusterScopeV2) reconcileSubnet(ctx context.Context, subnet infrav1.Subnet, isControlPlane bool) (bool, error) { //nolint: gocyclo
	log := ctrl.LoggerFrom(ctx)
...
func (s *ClusterScopeV2) buildSubnetsForZones() ([]infrav1.Subnet, error) {
...
func (s *ClusterScopeV2) updateSubnetStatus(subnetDetails *vpcv1.Subnet, isControlPlane bool) (bool, error) {
	requeue := true
...
func (s *ClusterScopeV2) createSubnet(ctx context.Context, subnet infrav1.Subnet, isControlPlane bool) error {
...
func (s *ClusterScopeV2) findOrCreatePublicGateway(ctx context.Context, zone string) (*vpcv1.PublicGateway, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (s *ClusterScopeV2) ReconcileSecurityGroups(ctx context.Context) (bool, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (s *ClusterScopeV2) reconcileSecurityGroup(ctx context.Context, securityGroup infrav1.VPCSecurityGroup) error {
	log := ctrl.LoggerFrom(ctx)
...
func (s *ClusterScopeV2) reconcileSecurityGroupRules(ctx context.Context, securityGroup infrav1.VPCSecurityGroup) (bool, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (s *ClusterScopeV2) findOrCreateSecurityGroupRule(ctx context.Context, securityGroupID string, securityGroupRule infrav1.VPCSecurityGroupRule, existingSecurityGroupRules *vpcv1.SecurityGroupRuleCollection) error { //nolint: gocyclo
	log := ctrl.LoggerFrom(ctx)
...
func (s *ClusterScopeV2) checkSecurityGroupRuleProtocolIcmp(ctx context.Context, securityGroupRulePrototype infrav1.VPCSecurityGroupRulePrototype, securityGroupRuleRemote infrav1.VPCSecurityGroupRuleRemote, existingRule *vpcv1.SecurityGroupRuleSecurityGroupRuleProtocolIcmp) (bool, error) {
	log := ctrl.LoggerFrom(ctx)
	if exists, err := s.checkSecurityGroupRulePrototypeRemote(ctx, securityGroupRuleRemote, existingRule.Remote); err != nil {
...
func (s *ClusterScopeV2) checkSecurityGroupRuleProtocolTcpudp(ctx context.Context, securityGroupRulePrototype infrav1.VPCSecurityGroupRulePrototype, securityGroupRuleRemote infrav1.VPCSecurityGroupRuleRemote, existingRule *vpcv1.SecurityGroupRuleSecurityGroupRuleProtocolTcpudp) (bool, error) {
	log := ctrl.LoggerFrom(ctx)
...
func (s *ClusterScopeV2) createSecurityGroupRuleAllRemotes(ctx context.Context, securityGroupID string, securityGroupRule infrav1.VPCSecurityGroupRule) error {
...
func (s *ClusterScopeV2) createSecurityGroupRule(ctx context.Context, securityGroupID string, securityGroupRule infrav1.VPCSecurityGroupRule, remote infrav1.VPCSecurityGroupRuleRemote) error {
	log := ctrl.LoggerFrom(ctx)
...
func (s *ClusterScopeV2) createSecurityGroupRuleRemote(remote infrav1.VPCSecurityGroupRuleRemote) (*vpcv1.SecurityGroupRuleRemotePrototype, error) {
...
func (s *ClusterScopeV2) ReconcileLoadBalancers(ctx context.Context) (bool, error) {
...
func (s *ClusterScopeV2) isLoadBalancerReady(ctx context.Context, status infrav1.VPCLoadBalancerState) bool {
	log := ctrl.LoggerFrom(ctx)
	switch status {
...
func (s *ClusterScopeV2) getLoadBalancer(lb infrav1.VPCLoadBalancerSpec) (*infrav1.VPCLoadBalancerStatus, error) {
...
func (s *ClusterScopeV2) createLoadBalancer(ctx context.Context, loadBalancer infrav1.VPCLoadBalancerSpec) error {
	log := ctrl.LoggerFrom(ctx)
...
func (s *ClusterScopeV2) getLoadBalancerSubnetIDs(loadBalancer infrav1.VPCLoadBalancerSpec) ([]string, error) {
...
func (s *ClusterScopeV2) getLoadBalancerSecurityGroupIDs(loadBalancer infrav1.VPCLoadBalancerSpec) ([]string, error) {
...
func (s *ClusterScopeV2) buildLoadBalancerListener(additionalListener infrav1.AdditionalListenerSpec) vpcv1.LoadBalancerListenerPrototypeLoadBalancerContext {
